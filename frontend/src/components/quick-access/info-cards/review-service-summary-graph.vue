  ...
  v-card(outlined)
    ...
    v-card-text
      ...
      v-container.grey.lighten-4.mb-5.rounded-lg
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }")
            v-row(v-if="review_requested_by" dense v-bind="attrs" v-on="on") 
                v-col
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }")
            v-row(v-if="reviewer_selected_by" dense v-bind="attrs" v-on="on")
              v-col
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }")
            v-row(v-if="public_interaction" dense v-bind="attrs" v-on="on")
              v-col
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }")
            v-row(v-if="opportunity_for_author_response" dense v-bind="attrs" v-on="on")
              v-col
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }")
            v-row(v-if="recommendation" dense v-bind="attrs" v-on="on")
              v-col
      ...
      v-container.grey.lighten-4.rounded-lg
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }" )
            v-row(v-if="peer_review_policy" dense v-bind="attrs" v-on="on")
              v-col
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }" )
            v-row(v-if="review_coverage" dense v-bind="attrs" v-on="on")
              v-col
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }" )
            v-row(v-if="reviewer_identity_known_to" dense v-bind="attrs" v-on="on")
              v-col
        ...
        v-tooltip(top)
          template(v-slot:activator="{ on, attrs }" )
            v-row(v-if="competing_interests" dense v-bind="attrs" v-on="on")
              v-col
